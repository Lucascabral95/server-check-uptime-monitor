  ...
  try {
    ...
    if (isAxiosError(error)) {
      ...
      const message =
        error.response?.data?.message ||
        error.message ||
        "Error al obtener los monitores";
      throw { status, message };
    }
    throw error;
  }
...
export async function updateUptimeById(
  id: string,
  updateUptimeDto: UpdateUptimeDto,
) {
  try {
    ...
    if (isAxiosError(error)) {
      ...
      const message =
        error.response?.data?.message ||
        error.message ||
        "Error al actualizar el monitor";
      throw { status, message };
    }
    throw error;
  }
  ...
  try {
    ...
    if (isAxiosError(error)) {
      ...
      const message =
        error.response?.data?.message ||
        error.message ||
        "Error al obtener estadísticas avanzadas de logs por UptimeId";
      throw { status, message };
    }
    throw error;
  }
  ...
  try {
    ...
    if (isAxiosError(error)) {
      ...
      const message =
        error.response?.data?.message ||
        error.message ||
        "Error al obtener estadísticas de mis enlaces";
      throw { status, message };
    }
    throw error;
  }
  ...
  try {
    ...
    if (isAxiosError(error)) {
      ...
      const message =
        error.response?.data?.message ||
        error.message ||
        "Error al obtener incidentes de logs de un Monitor";
      throw { status, message };
    }
    throw error;
  }
...
export async function getIncidentsByUser(params?: {
  search?: string;
  sortBy?: string;
}) {
  try {
    ...
    if (isAxiosError(error)) {
      ...
      const message =
        error.response?.data?.message ||
        error.message ||
        "Error al obtener incidentes de tus links creados";
      throw { status, message };
    }
    throw error;
  }
...
export async function forceFlushUptime() {
  try {
    const { data } = await axiosInstance.post("/uptime/flush");
    ...
    if (isAxiosError(error)) {
      ...
      const message =
        error.response?.data?.message ||
        error.message ||
        "Error al forzar flush del buffer de logs";
      throw { status, message };
    }
    throw error;
  }
  ...
  try {
    ...
    if (isAxiosError(error)) {
      ...
      const message =
        error.response?.data?.message ||
        error.message ||
        "Error al obtener estadísticas de los monitores";
      throw { status, message };
    }
    throw error;
  }
...
export async function getMonitorAggregates(
  id: string,
  granularity: "HOURLY" | "DAILY" = "HOURLY",
) {
  const { data } = await axiosInstance.get(`/uptime/stats/aggregates/${id}`, {
    params: { granularity },
  });
  return data;
}
