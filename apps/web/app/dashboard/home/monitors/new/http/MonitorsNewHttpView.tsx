      ...
      <form className="monitor-card" onSubmit={handleSubmit}>
            ...
            <div className="big-select-content">
              ...
              <div className="text-content">
                ...
                <div className="subtitle">
                  Usá el monitor HTTP(S) para supervisar tu sitio web, endpoint
                  de API, o cualquier servicio que funcione sobre HTTP.
                </div>
              </div>
            </div>
            <IconChevron />
        ...
        <div className="grid-2-col">
          <div className="form-section">
            <div className="label-row">
              ...
              <span className="premium-badge">
                <IconLock /> Grupos disponibles solo en <strong>Paid</strong>{" "}
                plans. <a href="#">Upgrade now</a>
              </span>
            </div>
            ...
            <p className="helper-text">
              Tu monitor será agregado automáticamente al grupo seleccionado
            </p>
          </div>
          ...
          <div className="form-section">
            ...
            />
            <p className="helper-text">
              Agregale un nombre para que puedas identificarlo mejor
            </p>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div className="notify-grid">
            ...
            >
              <div className="tile-header">
                <div
                  className={`checkbox-custom ${notify.email ? "checked" : ""}`}
                ></div>
            ...
            <div className="notify-tile disabled">
              ...
              <div className="tile-subtitle">
                <a href="#">Agregar número de teléfono</a>
              </div>
              <div className="tile-footer">
                <IconRefresh /> Sin delay, sin repetición
              </div>
            ...
            <div className="notify-tile disabled">
              ...
              <div className="tile-subtitle">
                Descarga la app para <a href="#">iOS</a> o{" "}
                <a href="#">Android</a>
              </div>
              <div className="tile-footer">
                <IconRefresh /> Sin delay, sin repetición
          ...
          <p className="note-text">
            Podés configurar las notificaciones para{" "}
            <a href="#">Integraciones & Equipo</a> en la pestaña específica y
            editarla más tarde.
          </p>
        </div>
        ...
        <div className="form-section">
          ...
          <p className="interval-desc">
            Tu monitor será verificado cada{" "}
            <strong>{INTERVAL_OPTIONS[intervalIndex].label}</strong> (
            {currentFrequency} segundos). Recomendamos usar al menos 1 minuto de
            verificación <a href="#">disponible en planes pagos</a>
          </p>
...
export default MonitorsNewHttpView;
